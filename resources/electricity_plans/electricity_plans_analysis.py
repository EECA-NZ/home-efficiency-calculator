"""
Script for generating scatter plots of electricity plans based on the tariff data.
...
available. We approximate the electricity plans available for each postcode by mapping
...
filter_electricity_plans in electricity_plan_helpers.py for more details about the
filtering applied.
...
def main():
    ...
    my_df = filter_electricity_plans(my_df)

...
INLET_WATER_TEMPERATURE_BY_CLIMATE_ZONE = {
    ...
    "Unknown": 15.0,  # What should this be?
}
...
KNOWN_TANK_SIZE_LOSSES_KWH_PER_DAY = {130: 1.56, 180: 1.76, 250: 2.16}
...
GAS_INSTANTANEOUS_WATER_HEATING_EFFICIENCY = 0.9

GAS_STORAGE_WATER_HEATING_EFFICIENCY = 0.9
